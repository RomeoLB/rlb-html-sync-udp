console.log("Old BSSyncManager Slave with UDP control test 2.1");
...
let syncFileName = "Future Neon - UL.mp4";
let nonSyncFileName = "logi-3.mp4";

videoElement1.src = syncFileName;
videoElement2.src = nonSyncFileName;

MediaSync.onsyncevent = function(e){
    console.log(" Slave MediaSync.onsyncevent to play video: " + e.iso_timestamp + " File Index: " + e.id);
